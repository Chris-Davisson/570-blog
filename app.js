...
<head>
  ...
  <style>
    ...
    .container {
      ...
      background: #fff;
      box-shadow: 0 6px 32px 0 #2221ff07;
      border-radius: 18px;
...
<body>
  <div class="container">
    <div class="meta">
      <span><strong>Christopher Davisson</strong> | Roblox Cookie Stealer Malwarious Extension Deobfuscation</span><br>
    ...
    <h2>Explicitly Stated Objective</h2>
    <p>
...
&lt;/div&gt;
    ...
    <p>
      The rest and most of the objects are encoded into large arrays of strings and encoded with URI and obfuscated with hex math.
    </p>
    <p>
      This file seems to handle the actual theft of cookies. It also captures and uses two-auth information by serving as a middle man between the user and the Roblox servers. After that it attempts to steal the other cookies.
    </p>

    <h3>content.js</h3>
    <p>
      This file seems to handle the security login for Roblox. It tries to convince the user to enable dev mode, opening it up to cookie theft.
    </p>
    <p>
      Here I see more suspicious function names:<br>
    ...
    <h3>popup.js</h3>
    <h4>What this seems to handle</h4>
    <!-- Content left as an anchor for future detail -->
